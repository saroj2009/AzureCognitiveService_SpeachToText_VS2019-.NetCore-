...
namespace MicrosoftSpeechSDKSamples
{
    public class TranslationSamples
    {
        ...
        public static async Task TranslationWithFileAsync()
        {
            ...
            // Creates an instance of a speech translation config with specified subscription key and service region.
            // Replace with your own subscription key and service region (e.g., "westus").
            var config = SpeechTranslationConfig.FromSubscription("01001d8e6e1444418ca5eb7a2972dafd", "southcentralus");
            config.SpeechRecognitionLanguage = fromLanguage;
            ...
            try { 
            using (var audioInput = AudioConfig.FromWavFileInput(@"D:\Newfolder\whatstheweatherlike.wav"))
            {
